...
@pytest.mark.parametrize(
    ...
    [
        (3.1,np.random.randint(10,size=(10,10)),Lens(10,10),5,"The gain and the maximum iterator must be Integers"),
        (3,np.random.randint(10,size=(10,10)),Lens(10,10),5.1,"The gain and the maximum iterator must be Integers"),
        (3.1,np.random.randint(10,size=(10,10)),Lens(10,10),5.1,"The gain and the maximum iterator must be Integers"),
